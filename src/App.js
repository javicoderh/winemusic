...
function App() {
  ...
  <button className='submit'><img className='notes' src='https://www.nicepng.com/png/full/50-506482_download-svg-download-png-emoji-notas-musicales-png.png'width="30" height="30" alt="musicNote"></img></button>
    ...
    <Route path="/honey">     
      ...
      <iframe width="560" height="315" src="https://www.youtube.com/embed/Kfaul5VDvtc?autoplay=1&mute=0&start=6" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
      <Link  href='/'>
